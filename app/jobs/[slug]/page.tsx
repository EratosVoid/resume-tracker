          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-success-50 to-success-100/50 backdrop-blur-sm rounded-xl p-6 border border-success-200/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-success-800">Great Benefits</h3>
                  <p className="text-sm text-success-600">Competitive package included</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-primary-100/50 backdrop-blur-sm rounded-xl p-6 border border-primary-200/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-primary-800">Growth Opportunities</h3>
                  <p className="text-sm text-primary-600">Advance your career with us</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-secondary-50 to-secondary-100/50 backdrop-blur-sm rounded-xl p-6 border border-secondary-200/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-secondary-800">Top Rated Company</h3>
                  <p className="text-sm text-secondary-600">Join our award-winning team</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="bg-gradient-to-r from-success-50 to-success-100/50 backdrop-blur-sm rounded-xl p-4 border border-success-200/50">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-success-700 font-medium">Response Time</span>
                      </div>
                      <span className="font-bold text-success-600">2-3 days</span>
                    </div>
                  </div>
